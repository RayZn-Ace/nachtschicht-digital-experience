            ...
            <div className="space-y-2.5">
              {nativeApp && (
                <div className="rounded-lg border border-border bg-muted/50 p-3 text-xs text-muted-foreground">
                  {lang === "de"
                    ? "Google- und Apple-Login sind in der iOS-App vorübergehend deaktiviert. Bitte nutze E-Mail und Passwort."
                    : "Google and Apple sign-in are temporarily disabled in the iOS app. Please use email and password."}
                </div>
              )}
              <button
                type="button"
