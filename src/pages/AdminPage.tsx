...
import { isEventPast as isEventPastBerlin } from "@/lib/eventTime";

const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL;
const ALWAYS_OPEN_AREAS = ["openair", "bistro"];

/** Determine if an event is truly past, considering end_date/end_time in Berlin time */
const isEventPast = (e: any, _now: Date): boolean => isEventPastBerlin(e);
...
const AdminPage = () => {
  ...
  const validTabs = ["events", "ticketcenter", "livecheckin", "albums", "newsletter", "u18", "tracking", "tags", "codes", "lounges", "loungemanage", "drinks", "holidays", "invoiceconfig", "revenue", "controlling", "reports", "applicants", "customers", "lostfound", "csvmigration", "usermanagement"] as const;
